...
window.onload = function () {
    ...
    for (var t of tags) addTags(t, "applications.html?search=" + t, true);
...
function phanTich_URL_chiTietSanPham() {
    ...
    // Hình nhỏ
    addSmallImg("image/huawei-mate-20-pro-green-600x600.jpg");
    addSmallImg("image/oppo-f9-mau-do-1-org.jpg");
    addSmallImg("image/oppo-f9-mau-do-2-org.jpg");
    addSmallImg("image/oppo-f9-mau-do-3-org.jpg");
    addSmallImg("image/huawei-mate-20-pro-green-600x600.jpg");
    addSmallImg("image/oppo-f9-mau-do-3-org.jpg");
    addSmallImg("image/huawei-mate-20-pro-green-600x600.jpg");
