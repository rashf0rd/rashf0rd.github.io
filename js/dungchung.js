	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                <li><a href="applications.html"><i class="fa fa-home"></i> Trang chủ</a></li>
	...
	<div class="header group">
        <div class="logo">
            <a href="applications.html">
                <img src="image/logo.jpg" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->

        <div class="content">
            <div class="search-header" style="position: relative; left: 162px; top: 1px;">
                <form class="input-search" method="get" action="applications.html">
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="applications.html">LDD Phone Store</a> - All rights reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">Jose T</span></p>
    </div>`);
}
